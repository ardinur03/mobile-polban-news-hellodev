...
class AppStyle {
  static TextStyle txtInterSemiBold10Indigo900bf = TextStyle(
    color: ColorConstant.indigo900Bf,
  ...
  static TextStyle txtInterSemiBold10Black9004c = TextStyle(
  ...
  static TextStyle txtInterBlack18 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      18,
    ),
